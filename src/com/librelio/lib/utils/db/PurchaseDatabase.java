...
public class PurchaseDatabase {
    ...
    public Cursor queryPurchasedItem(String id){
    	Cursor c = mDb.query(PURCHASED_ITEMS_TABLE_NAME, PURCHASED_COLUMNS, 
    			id + "=" + "'" + PURCHASED_PRODUCT_ID_COL + "'",
    			null, null, null, null);
    	if(c != null)
    		c.moveToFirst();
    	return c;
    ...
    public long queryPurchasedItemCount(String id){
    	Cursor c = queryPurchasedItem(id);
    	if(c != null){
    		return c.getLong(c.getColumnIndex(PURCHASED_QUANTITY_COL));
    	}
    	return 0;
    }
    
    public Cursor queryAllPurchaseHistory() {
    	return mDb.query(PURCHASE_HISTORY_TABLE_NAME, HISTORY_COLUMNS, null, null, null, null, null);
    }
