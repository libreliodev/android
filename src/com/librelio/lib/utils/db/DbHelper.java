...
public class DbHelper{
    ...
    public DbHelper open() throws SQLException { 
    	Log.d(TAG, DATABASE_ISSUE_POPULATE);
	...
	public static final String MAGAZINE_VERSION_KEY = "version";
	protected static final int MAGAZINE_VERSION_COLUMN = 2;
	public static final String MAGAZINE_BASE_URL_KEY = "base_url";
	...
	// Magazine CREATION 
	private static final String DATABASE_MAGAZINE_CREATE = "create table " + MAGAZINE_TABLE + " (" + 
				 MAGAZINE_ROW_ID + " integer primary key autoincrement" + ", " + 
				 MAGAZINE_NAME_KEY + " text  " + ", " + 
				 MAGAZINE_VERSION_KEY + " integer  " + ", " + 
				 MAGAZINE_BASE_URL_KEY + " text  " + ");";
	

	// Issue CREATION 
	private static final String DATABASE_ISSUE_CREATE = "create table " + ISSUE_TABLE + " (" + 
				 ISSUE_ROW_ID + " integer primary key autoincrement" + ", " + 
				 ISSUE_MAGAZINE_ID_KEY + " integer  " + ", " + 
				 ISSUE_STATE_KEY + " integer  " + ", " + 
				 ISSUE_NAME_KEY + " text  " + ", " + 
				 ISSUE_DATE_KEY + " text  " + ", " + 
				 ISSUE_PRICE_KEY + " text  " + ", " + 
				 ISSUE_PDF_URL_KEY + " text  " + ", " + 
				 ISSUE_PREVIEW_PATH_KEY + " text  " + ", " + 
				 ISSUE_COVER_PATH_KEY + " text  " + ", " + 
				 ISSUE_ISSUE_PATH_KEY + " text  " + ");";

	private static final String DATABASE_ISSUE_POPULATE = "insert into " + ISSUE_TABLE + " (" +
			 ...
			 ISSUE_PREVIEW_PATH_KEY + " text  " + ", " + 
			 ISSUE_COVER_PATH_KEY + " text  " + ", " + 
			 ISSUE_ISSUE_PATH_KEY + " text  " + " ) values ( " + 
			 "( " +
				 "0, " +
				 "1, " +
				 "'Выпуск № 4, 2011'," +
				 " 'Декабрь, 2011', " +
				 "'Бесплатно', " +
				 "'http://ocean-magazin.ru/archives/OCEAN_4_All_v2.pdf', " +
				 "'http://ocean-magazin.ru/archives/4_obl.jpg' " +
			 ")" +
	...
	// -------------- MAGAZINE HELPERS ------------------
	public long addMagazine(String name, Integer version, String base_url)
	{
		ContentValues contentValues = new ContentValues();
		contentValues.put(MAGAZINE_NAME_KEY, name);
		contentValues.put(MAGAZINE_VERSION_KEY, version);
		contentValues.put(MAGAZINE_BASE_URL_KEY, base_url);
		return mDb.insert(MAGAZINE_TABLE, null, contentValues);
	
	}

	public long updateMagazine(long rowIndex, String name, Integer version, String base_url)
	{
	...
	{
		return mDb.delete(MAGAZINE_TABLE, MAGAZINE_ROW_ID + " = " + rowIndex, null) > 0;
	}
	...
	{
		return mDb.query(MAGAZINE_TABLE, new String[] {
					MAGAZINE_ROW_ID,
					MAGAZINE_NAME_KEY,
					MAGAZINE_VERSION_KEY,
					MAGAZINE_BASE_URL_KEY}, null, null, null, null, null);
	}

	public Cursor getMagazine(long rowIndex)
	{
		Cursor res = mDb.query(MAGAZINE_TABLE, new String[] {
					MAGAZINE_ROW_ID,
					MAGAZINE_NAME_KEY,
					MAGAZINE_VERSION_KEY,
					MAGAZINE_BASE_URL_KEY}, MAGAZINE_ROW_ID + " = " + rowIndex, null, null, null, null);
		if(res != null){
			res.moveToFirst();
		}
		return res;
	...
	// -------------- ISSUE HELPERS ------------------
	public long addIssue(Integer magazine_id, Integer state, String name, String date, String price, String pdf_url, String preview_path, String cover_path, String issue_path)
	{
		ContentValues contentValues = new ContentValues();
	...
	public long updateIssue(long rowIndex, Integer magazine_id, Integer state, String name, String date, String price, String pdf_url, String preview_path, String cover_path, String issue_path)
	{
	...
	{
		return mDb.query(ISSUE_TABLE, new String[] {
					ISSUE_ROW_ID,
					ISSUE_MAGAZINE_ID_KEY,
					ISSUE_STATE_KEY,
					ISSUE_NAME_KEY,
					ISSUE_DATE_KEY,
					ISSUE_PRICE_KEY,
					ISSUE_PDF_URL_KEY,
					ISSUE_PREVIEW_PATH_KEY,
					ISSUE_COVER_PATH_KEY,
					ISSUE_ISSUE_PATH_KEY}, null, null, null, null, null);
	}

	public Cursor getIssue(long rowIndex)
	{
		Cursor res = mDb.query(ISSUE_TABLE, new String[] {
					ISSUE_ROW_ID,
					ISSUE_MAGAZINE_ID_KEY,
					ISSUE_STATE_KEY,
					ISSUE_NAME_KEY,
					...
					ISSUE_PREVIEW_PATH_KEY,
					ISSUE_COVER_PATH_KEY,
					ISSUE_ISSUE_PATH_KEY}, ISSUE_ROW_ID + " = " + rowIndex, null, null, null, null);
		if(res != null){
			res.moveToFirst();
		}
		return res;
...
//				ISSUE_PREVIEW_PATH_KEY,
//				ISSUE_COVER_PATH_KEY,
//				ISSUE_ISSUE_PATH_KEY}, ISSUE_SKU + " = " + sku, null, null, null, null);
//		if(res != null){
//			res.moveToFirst();
//		}
//		return res;
