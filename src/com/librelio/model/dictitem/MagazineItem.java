...
public class MagazineItem extends DictItem implements DisplayableAsGridItem {
...
//	private boolean isSample;
	...
	public boolean isDownloaded() {
		return new File(getItemFileName()).exists();
	}
...
//		}
	...
	public void deleteMagazine() {
		...
		MagazineManager.removeDownloadedMagazine(context, this);
