...
public class SearchCursorViewBinder {
	Context context;
	...
	public SearchCursorViewBinder(Context context, String[] columns, int[] ids) {
		this.context = context;
	...
	public boolean bindView(View v, Cursor c) {
		...
		if(v instanceof ImageView) {
			...
			try {
				Bitmap pic = BitmapFactory.decodeStream(context.getAssets()
						.open("testmatos/" + value));
