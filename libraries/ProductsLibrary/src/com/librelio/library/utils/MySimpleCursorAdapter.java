 ...
 */
public class MySimpleCursorAdapter extends MyResourceCursorAdapter {
    /**
    ...
    public MySimpleCursorAdapter(Context context, int layout, Cursor c, String[] from,
            int[] to, int flags, String id_field) {
        super(context, layout, c, flags, id_field);
        mTo = to;
        mOriginalFrom = from;
        findColumns(from);
    }
     ...
     * SimpleCursorAdapter.
     *
     * @see MySimpleCursorAdapter#bindView(android.view.View, android.content.Context, android.database.Cursor)
     * @see MySimpleCursorAdapter#setViewImage(ImageView, String) 
     * @see MySimpleCursorAdapter#setViewText(TextView, String)
     */
