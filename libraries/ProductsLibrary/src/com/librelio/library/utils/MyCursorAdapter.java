 ...
 */
public abstract class MyCursorAdapter extends BaseAdapter implements Filterable,
        MyCursorFilter.CursorFilterClient {
	
	public static final String ID_FIELD = "_id";
	protected String id_field = ID_FIELD;
    /**
     ...
     * {@hide}
     */
    protected MyCursorFilter mCursorFilter;
    /**
     * This field should be made private, so it is hidden from the SDK.
     * {@hide}
     */
    ...
    public MyCursorAdapter(Context context, Cursor c) {
        init(context, c, FLAG_AUTO_REQUERY, ID_FIELD);
    }
    ...
    public MyCursorAdapter(Context context, Cursor c, boolean autoRequery) {
        init(context, c, autoRequery ? FLAG_AUTO_REQUERY : FLAG_REGISTER_CONTENT_OBSERVER, ID_FIELD);
    }
     ...
     */
    public MyCursorAdapter(Context context, Cursor c, int flags, String id_field) {
        init(context, c, flags, id_field);
    }
    ...
    public Filter getFilter() {
        if (mCursorFilter == null) {
            mCursorFilter = new MyCursorFilter(this);
        }
