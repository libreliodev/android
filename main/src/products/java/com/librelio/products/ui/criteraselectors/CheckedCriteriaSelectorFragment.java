package com.librelio.products.ui.criteraselectors;
...
import com.librelio.products.utils.adapters.CheckedCriteriaViewBinder;
import com.librelio.products.utils.adapters.checked.CheckedCriteriaAdapter;
...
public class CheckedCriteriaSelectorFragment extends Fragment {
	...
	private void init(int pPosition, OnCriteriaChangedListener l) {
		...
		titleResourceId = CustomizationHelper.CriteriaSelectorConstants.CRITERIA_SELECTOR_RIGHTPANE_TITLE_TEXTVIEW;
		layoutId = CustomizationHelper.CriteriaSelectorConstants.CRETERIA_SELECTOR_FRAGMENT_LAYOUT_ID;
		itemLayoutId = CustomizationHelper.CriteriaSelectorConstants.CHECKED_CRITERIA_SELECTOR_ITEM_LAYOUT_ID;
		listViewId = CustomizationHelper.CriteriaSelectorConstants.CRETERIA_SELECTOR_LISTVIEW_VIEW_ID;
		itemTextViewId = CustomizationHelper.CriteriaSelectorConstants.CRITERIA_SELECTOR_CRITERIA_TEXTVIEW_VIEW_ID;
		itemCheckBoxId = CustomizationHelper.CriteriaSelectorConstants.CRITERIA_SELECTOR_CRITERIA_CHECKBOX_VIEW_ID;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		TextView criteriaTitle = (TextView) rootView
				.findViewById(CustomizationHelper.CriteriaSelectorConstants.CRETERIA_SELECTOR_TITLE_VIEW_ID);
		criteriaTitle.setText(title);
		ListView mCreteriaSelectorListView = (ListView) rootView
				.findViewById(listViewId);
		if (!type.equals(CustomizationHelper.NUMERIC)) {
			try {
		...
		mAdapter.setOnCriteriaCangeListener(new CheckedCriteriaAdapter.CriteriaChangeListener() {
