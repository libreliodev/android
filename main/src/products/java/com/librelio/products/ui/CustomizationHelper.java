...
import com.librelio.products.ui.lexique.LexiqueFragment;
...
import com.librelio.products.ui.productsearch.ProductSearchFragment;
...
public class CustomizationHelper {
	...
	public static class ProductSearchConstants {
		...
		public static final String[] PRODUCT_SEARCH_BINDER_COLUMNS = new String[] {
				...
				ProductsDBHelper.MODELE_MARQUE_KEY, ProductsDBHelper.MODELE_MODELE_KEY,
				"Gamme", "Prix_String", };
		public static final String[] PRODUCT_SEARCH_SEARCH_COLUMNS = new String[] {
				ProductsDBHelper.MODELE_MARQUE_KEY, ProductsDBHelper.MODELE_MODELE_KEY, "Gamme" };
	...
	private static class ProductListConstants {
		...
		private static int[] PRODUCT_LIST_DISPLAY_VIEW_IDS;
//                = new int[] {
//				R.id.productListItemGenre, R.id.productListItemModele,
...
//				R.id.productListItemPicture };
	...
	public static String ASSETS_PHOTOS_URI;
	...
	public static ProductDetailFragment getProductDetailFragment(Cursor pCursor,
			ProductDetailFragment.ShareProductListener pListener) {
        // TODO this should set arguments on the fragment in case it is recreated.
	...
	public static FavoriteProductListFragment getFavoriteProductListFragment(Context context) {
		return FavoriteProductListFragment.getInstance(ProductsDBHelper.getDBHelper(),
				DETAIL_TABLE_NAME,
				ProductListConstants.PRODUCT_LIST_FAGMENT_LAYOUT,
				ProductListConstants.PRODUCT_LIST_LISTVIEW_VIEW_ID,
				ProductListConstants.PRODUCT_LIST_LISTVIEW_ITEM_LAYOUT,
	...
	public static ProductSearchFragment getProductSearchFragment(Context context, int searchEditTextId) {
		return ProductSearchFragment.getInstance(ProductsDBHelper.getDBHelper(),
				DETAIL_TABLE_NAME,
	...
	public static RangeCriteriaSelectorFragment getRangeCriteriaSelectorFragment(Context context, String type, String criteria, String colName,
			RangeCriteriaSelectorFragment.OnRangeCriteriaChangedListener l) {
	...
	public static void initCustomization(Context context) {
		InputStream is;
		try {
			is = context.getAssets().open("customization.json");
			...
			for (int i = 0; i < displayViewIds.length(); i++) {
				...
				ProductListConstants.PRODUCT_LIST_DISPLAY_VIEW_IDS[i] = context.getResources()
